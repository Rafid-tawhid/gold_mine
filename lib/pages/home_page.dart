                        ...
                        itemBuilder: (BuildContext context, int index) => Card(
                          child: InkWell(
                            onTap: () {
                              ...
                              EasyLoading.show();
                              provider.getMaterialInfo(context,provider.sectionsName[index].id.toString()).then((value) {
                                EasyLoading.dismiss();
                              });
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: TextField(
                                          ...
                                          onChanged: (value){
                                            if(value.isNotEmpty){
                                              myController.getTotalPrice(value,provider.materialsInfoList[index].price!);
