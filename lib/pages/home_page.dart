            ...
            child: Column(
                ...
                children: <Widget>[
                  ...
                  GridView.builder(
                    ...
                    itemCount: showItemList.length, // Number of items in the grid
                    itemBuilder: (BuildContext context, int index) {
                      return InkWell(
                        onTap: (){
                          // _showBottomSheet(context);
                          showDialog(context: context, builder: (context)=>AlertDialog(
                            title: Text(showItemList[index].sectionName!),
                            content: Column(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                Padding(
                                  ...
                                  child: TextField(
                                    ...
                                    onChanged: (value){
                                      setState(() {
                                        ...
                                        price=showItemList[index].price!*vori;
                              ...
                              child: Card(
                                ...
                                child: Center(
                                  child: Column(
                                    mainAxisSize: MainAxisSize.min,
                                    children: [
                                      Text('${showItemList[index].subSectionName}',style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold),),
                                      SizedBox(height: 5,),
                                      Text('1gm =${showItemList[index].price} Tk'),
                                    ],
                                  ),
                                ),
                              ),
